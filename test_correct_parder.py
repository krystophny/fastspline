#!/usr/bin/env python3
"""
Test the corrected parder implementation.
"""
import numpy as np
from scipy.interpolate import bisplrep, bisplev
from fastspline.numba_implementation.parder_correct import call_parder_safe

def test_corrected_parder():
    """Test the corrected parder"""
    print("=== Testing Corrected Parder ===")
